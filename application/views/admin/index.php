  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo mr-5" href="adminAssets/index.html"><img src="<?php echo site_url("assets/logo.png"); ?>" class="mr-2" alt="logo"/></a>
        <a class="navbar-brand brand-logo-mini" href="adminAssets/index.html"><img src="<?php echo site_url("assets/logo_lettre.png"); ?>" alt="logo"/></a>
      </div>
    </nav>
    <!-- partial -->
